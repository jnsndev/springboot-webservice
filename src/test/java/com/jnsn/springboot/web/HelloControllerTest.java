...
import com.jnsn.springboot.config.auth.SecurityConfig;
...
// WebMvcTest: web에 집중할 수 있는 스프링 테스트 어노테이션 (JPA 기능은 작동X, CustomOAuth2UserService 스캔X, 일반적인 @Configuration 스캔X)
